...
const VARIANT_CLS: Record<NonNullable<StatCardProps['variant']>, string> = {
  ...
  violet: 'bg-secondary text-secondary-foreground dark:bg-secondary dark:text-secondary-foreground',
...
const BADGE_TONE: Record<BadgeTone, string> = {
  ...
  partial:      'bg-primary/10      text-primary    border-primary/20    dark:bg-primary/20 dark:text-primary',
