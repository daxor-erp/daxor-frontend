...
import { GET_STOCK_ADJUSTMENTS } from '@/gql/queries'
...
export default function StockAdjustmentsPage() {
  ...
  const { data, loading } = useQuery(GET_STOCK_ADJUSTMENTS, {
    variables: { organizationId: user?.organizationId },
    skip: !user?.organizationId,
  })

  const items = data?.stockadjustments || []
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage stock adjustments</p>
        </div>
        <Button>
