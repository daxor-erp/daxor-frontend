...
import { GET_GOODS_RECEIPTS } from '@/gql/queries'
...
export default function GoodsReceiptsPage() {
  ...
  const { data, loading } = useQuery(GET_GOODS_RECEIPTS, {
    variables: { organizationId: user?.organizationId },
    skip: !user?.organizationId,
  })

  const items = data?.goodsreceipts || []
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage goods receipts</p>
        </div>
        <Button>
