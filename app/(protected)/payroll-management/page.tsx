...
import { GET_PAYROLL_MANAGEMENTS } from '@/gql/queries'
...
export default function PayrollManagementPage() {
  ...
  const { data, loading } = useQuery(GET_PAYROLL_MANAGEMENTS, {
    variables: { organizationId: user?.organizationId },
    skip: !user?.organizationId,
  })

  const items = data?.payrollmanagements || []
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage payroll management</p>
        </div>
        <Button>
