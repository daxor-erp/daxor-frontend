...
import { GET_STOCK_TRANSFERS } from '@/gql/queries'
...
export default function StockTransfersPage() {
  ...
  const { data, loading } = useQuery(GET_STOCK_TRANSFERS, {
    variables: { organizationId: user?.organizationId },
    skip: !user?.organizationId,
  })

  const items = data?.stocktransfers || []
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage stock transfers</p>
        </div>
        <Button>
