...
import { GET_INVENTORY_CONTROLS } from '@/gql/queries'
...
export default function InventoryControlPage() {
  ...
  const { data, loading } = useQuery(GET_INVENTORY_CONTROLS, {
    variables: { organizationId: user?.organizationId },
    skip: !user?.organizationId,
  })

  const items = data?.inventoryControls || []
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage inventory control</p>
        </div>
        <Button>
