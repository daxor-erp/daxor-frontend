...
export default function SdlMasterPage() {
  ...
  if (!orgId) {
    return <p className="erp-page-desc">Select an organization for SDL master records.</p>
  }
    ...
    <div className="erp-shell">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          ...
          <h1 className="erp-page-title">Skills Development Levy (SDL) master</h1>
              ...
              <TableBody>
                {sortedRows.map((r) => (
                  <TableRow key={r.id} className="hover:bg-slate-50/60">
                    ...
                    <TableCell className="text-sm text-foreground">{r.levyLabel || '—'}</TableCell>
