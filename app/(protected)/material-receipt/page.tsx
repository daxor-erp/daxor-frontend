...
import { GET_MATERIAL_RECEIPTS } from '@/gql/queries'
...
export default function MaterialReceiptsPage() {
  ...
  const { data, loading } = useQuery(GET_MATERIAL_RECEIPTS, {
    variables: { organizationId: user?.organizationId },
    skip: !user?.organizationId,
  })

  const items = data?.materialreceipts || []
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage material receipts</p>
        </div>
        <Button>
